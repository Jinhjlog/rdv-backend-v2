...
import { PublicAuth } from '../../../auth/decorators/public-auth.decorator';

@ApiTags('인증 V2 - Auth 관리 (보안 강화)')
...
export class AuthV2Controller {
  ...
  @PublicAuth()
  @ApiOperation({
    summary: '게스트 - 계정 존재 확인 (V2)',
    description:
      'deviceId로 계정 존재 여부를 확인합니다.<br><br>' +
      '**V1 대비 변경사항**<br>' +
      '- API Key + Platform Attestation 검증이 추가되었습니다.<br>' +
      '- X-API-Key, X-Platform, X-Attestation-Token 헤더가 필수입니다.<br><br>' +
      '**목적**<br>' +
