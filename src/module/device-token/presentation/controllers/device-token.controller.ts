...
export class DeviceTokenController {
  ...
  @ApiOperation({
    summary: '디바이스 토큰 등록/갱신 [사용자]',
    description:
      'FCM 푸시 알림을 위한 디바이스 토큰을 등록하거나 갱신합니다.<br><br>' +
      '**필수 항목**<br>' +
      ...
      '2. 동일 토큰이 이미 존재하는 경우<br>' +
      '   - 동일 사용자: lastUsedAt 갱신 및 디바이스 정보 업데이트<br>' +
      '   - 다른 사용자: 기존 토큰 삭제 후 소유권 이전 (기기 변경)<br>' +
      '3. 새 토큰인 경우: 신규 등록<br><br>' +
      '**주의사항**<br>' +
      '- 앱 시작 시 매번 호출하여 토큰 신선도를 유지하는 것을 권장합니다.<br>' +
      '- FCM 검증에 실패한 유효하지 않은 토큰은 자동으로 무시됩니다.<br>' +
      '- 동일 토큰으로 다른 사용자가 등록하면 기존 소유권이 이전됩니다.<br>',
  })
  @ApiNoContentResponse({
