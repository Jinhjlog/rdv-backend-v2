...
| TC ID      | 시나리오                          | 분류               | 상태       |
| ---------- | --------------------------------- | ------------------ | ---------- |
| TC-EVT-001 | 일정 생성 성공                    | Happy Path         | [ ] 미작성 |
| TC-EVT-002 | 모집중 일정 최대 3개 초과 → 400   | 핵심 비즈니스 규칙 | [ ] 미작성 |
| TC-EVT-003 | 일정 목록 조회 성공               | Happy Path         | [ ] 미작성 |
| TC-EVT-004 | 일정 상세 조회 성공               | Happy Path         | [ ] 미작성 |
| TC-EVT-005 | 일정 수정 성공 (생성자)           | Happy Path         | [ ] 미작성 |
| TC-EVT-006 | 생성자가 아닌 사용자가 수정 → 400 | 핵심 비즈니스 규칙 | [ ] 미작성 |
| TC-EVT-007 | 일정 삭제 성공 (생성자)           | Happy Path         | [ ] 미작성 |
| TC-EVT-008 | 일정 참여 성공                    | Happy Path         | [ ] 미작성 |
| TC-EVT-009 | 이미 참여 중 재참여 → 400         | 핵심 비즈니스 규칙 | [ ] 미작성 |
| TC-EVT-010 | 일정 참여 철회 성공               | Happy Path         | [ ] 미작성 |
| TC-EVT-011 | 생성자가 참여 철회 → 400          | 핵심 비즈니스 규칙 | [ ] 미작성 |
