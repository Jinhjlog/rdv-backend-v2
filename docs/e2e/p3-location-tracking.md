...
| TC ID      | 시나리오                                    | 분류               | 상태       |
| ---------- | ------------------------------------------- | ------------------ | ---------- |
| TC-LOC-001 | 일정별 참여자 위치 목록 조회 성공           | Happy Path         | [ ] 미작성 |
| TC-LOC-002 | 위치 갱신 성공                              | Happy Path         | [ ] 미작성 |
| TC-LOC-003 | 존재하지 않는 위치 추적 레코드에 갱신 → 404 | 핵심 비즈니스 규칙 | [ ] 미작성 |
| TC-LOC-004 | 모임 외부 멤버가 위치 목록 조회 → 403       | 핵심 비즈니스 규칙 | [ ] 미작성 |
